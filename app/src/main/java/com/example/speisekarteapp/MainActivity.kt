...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(savedInstanceState != null){
            drink1.count = savedInstanceState.getInt("counter1")
            drink2.count = savedInstanceState.getInt("counter2")
            drink3.count = savedInstanceState.getInt("counter3")
            bill = savedInstanceState.getFloat("counter4")
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putInt("counter1", drink1.count)
        outState.putInt("counter2", drink2.count)
        outState.putInt("counter3", drink3.count)
        outState.putFloat("counter4", bill)
    }
}
